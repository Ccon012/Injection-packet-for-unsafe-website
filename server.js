...
app.get('/team_stats', function(req, res) {
	var q = "SELECT * FROM football_games;";
...
app.get('/player_info/select_player', function(req, res) {
	...
	var q = "SELECT * FROM football_players;";
	var id = "SELECT * FROM football_players WHERE id = " + player_id + ";";
	var played = "SELECT COUNT(id) FROM football_players INNER JOIN football_games ON id = ANY(players) WHERE id = " + player_id + ";";
		db.task('get-everything', task => {
			return task.batch([
				task.any(q),
				task.any(id),
